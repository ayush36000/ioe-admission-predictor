...
class EntranceStudent(models.Model):
    class Meta:
        db_table = "entrance_student"
...
class Addmission(models.Model):
    ...
    def __str__(self):
        return (
            ...
            f"| {self.collegeprogram.id.code} | {self.collegeprogram.program.name} | {self.batch}"
        )
